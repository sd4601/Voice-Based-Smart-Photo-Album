...
def store_json_elastic_search(json_object):
    ...
    host = 'https://search-photos-gfes2dre2wmbpkotigvd7j7zca.us-east-1.es.amazonaws.com/'
    index = 'photos'
    url = host + index + '/doc'
    headers = {"Content-Type": "application/json"}
    
    url2= 'https://search-photos-gfes2dre2wmbpkotigvd7j7zca.us-east-1.es.amazonaws.com/'
